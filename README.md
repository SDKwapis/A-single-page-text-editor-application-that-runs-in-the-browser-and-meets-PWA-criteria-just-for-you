# A single page text editor application that runs in the browser and meets PWA criteria just for you 	 [![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://opensource.org/licenses/MIT) 
